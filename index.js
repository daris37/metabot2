...
//
const BotName = 'METABOT'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/metabot.id/'; // Nama Instagramlu cok
const whatsapplu = '089693848709'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/LJQK3L8Hi7o5zXV1kgOeoN'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/Lt9It9zBSJcFUagwZod6g4'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @metabot.id`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @metabot.id`)
})
